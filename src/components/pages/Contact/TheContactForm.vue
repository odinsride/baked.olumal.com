    ...
    <div class="container">
      <div class="columns">
        <div class="column is-three-fifths is-offset-2">
          ...
          <h3 class="title is-3 has-text-primary">Contact Us</h3>
          ...
          <form name="contact"
            ...
            <div class="message-wrapper field">
              ...
              <div class="control">
                <textarea class="textarea" name="message" v-model="formData.message" placeholder="Leave us a message!"></textarea>
              </div>
            </div>
